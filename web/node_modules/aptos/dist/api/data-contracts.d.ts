 ...
 * @example 1635447454
 */
export declare type TimestampSec = string;
/**
 * Timestamp in microseconds, e.g. ledger / block creation timestamp.
 * @format uint64
 * @example 1632507671675208
 */
export declare type TimestampUsec = string;
/**
 * The version of the latest transaction in the ledger.
 * @format uint64
 * @example 52635485
 */
export declare type LedgerVersion = string;
/**
...
* @example 23
*/
export declare type EventSequenceNumber = string;
...
* @example 0x1::XUS::XUS
*/
export declare type MoveTypeTagId = string;
/**
...
*/
export declare type MoveTypeId = string;
/**
* String representation of an on-chain Move struct type.
...
* @example 0x1::AptosAccount::Balance<0x1::XUS::XUS>
*/
export declare type MoveStructTagId = string;
...
} & UserTransactionRequest & UserTransactionSignature & OnChainTransactionInfo;
export declare type BlockMetadataTransaction = {
    type: string;
    id: HexEncodedBytes;
    round: Uint64;
...
export declare type GenesisTransaction = {
    type: string;
    events: Event[];
...
*/
export declare type ScriptFunctionId = string;
...
export declare type WriteSet = ScriptWriteSet | DirectWriteSet;
...
* @example 3344000000
*/
export declare type MoveValue = any;
/**
...
export declare type TransactionSignature = Ed25519Signature | MultiEd25519Signature | MultiAgentSignature;
/**

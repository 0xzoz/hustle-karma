...
export declare class TransactionPayloadWriteSet extends TransactionPayload {
    serialize(serializer: Serializer): void;
...
export declare class TransactionPayloadModuleBundle extends TransactionPayload {
    readonly value: ModuleBundle;
    constructor(value: ModuleBundle);
    serialize(serializer: Serializer): void;
    static load(deserializer: Deserializer): TransactionPayloadModuleBundle;
}
export declare class TransactionPayloadScriptFunction extends TransactionPayload {
    readonly value: ScriptFunction;
